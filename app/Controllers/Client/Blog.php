...
class Blog extends Common {
    ...
    public function index() {
        $page_details = $this->admin_model->get_page_details_on_condition(["page_id" => BLOG_PAGE_ID]);
        ...
        $page_contents_details = $this->admin_model->get_page_content_details_on_condition(["page_id" => BLOG_PAGE_ID]);
        ...
        echo view('client/blog_view', $page_rendering_data);
